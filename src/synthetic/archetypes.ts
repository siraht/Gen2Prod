...
type NodeInput = Omit<CanonicalNode, "attributes" | "styles" | "conditionalStyles" | "children"> & {
  attributes?: Record<string, string>;
  styles?: Record<string, string>;
  conditionalStyles?: CanonicalNode["conditionalStyles"];
  children?: CanonicalNode[];
};

function node(input: NodeInput): CanonicalNode {
  return { attributes: {}, styles: {}, conditionalStyles: [], children: [], ...input };
}

const stackAtMobile = (styles: Record<string, string>): CanonicalNode["conditionalStyles"] => [{
  condition: { states: [], media: ["(max-width: 47.99rem)"], supports: [] },
  styles,
}];
...
export function createArchetypes(): CanonicalPageSpec[] {
  ...
  const hero = base("hero-cta", "hero-cta", page([
    node({ nodeId: "hero", tag: "section", role: "primary-intro", classes: ["hero", "hero--split"], attributes: { "aria-labelledby": "hero-title" }, styles: sharedStyles.section, children: [
      node({ nodeId: "hero-inner", tag: "div", role: "layout-container", classes: ["hero__inner"], styles: { ...sharedStyles.inner, display: "grid", gap: "var(--space-l)", "grid-template-columns": "repeat(2, minmax(0, 1fr))" }, conditionalStyles: stackAtMobile({ "grid-template-columns": "1fr" }), children: [
  ...
  const features = base("feature-grid", "feature-grid", page([node({ nodeId: "features", tag: "section", role: "product-features", classes: ["feature-grid"], attributes: { "aria-labelledby": "features-title" }, styles: sharedStyles.section, children: [
    node({ nodeId: "features-inner", tag: "div", role: "layout-container", classes: ["feature-grid__inner"], styles: sharedStyles.inner, children: [
      ...
      node({ nodeId: "features-list", tag: "ul", role: "feature-list", classes: ["feature-grid__list"], styles: { display: "grid", gap: "var(--space-m)", "grid-template-columns": "repeat(3, minmax(0, 1fr))", "list-style": "none", padding: "0", margin: "0" }, conditionalStyles: stackAtMobile({ "grid-template-columns": "1fr" }), children: featureItems }),
    ] }),
